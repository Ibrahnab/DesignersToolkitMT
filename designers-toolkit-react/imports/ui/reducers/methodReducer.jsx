    ...
    methods: [
        ...
        },
        {
            ...
            },
            {
                ...
                inSprint: false,
                currentPhase: "none",
                description:"This methods helps in selecting the most promising ideas for further development. ",
                steps: ["Review the learning outcomes and information gathered",
                "List the learning outcomes and information gathered",
                "Create grading criterias from bad to great",
                "Grade the list with the help of these criterias",
                "Pick the ones with the highest score for further development"],
                stepsNbr:["1","2","3"],
                inPhase:[],
                participantRange: "1+",
                timeRange: "10-60m",
            ...
            },
            {
                ...
                inSprint: false,
                currentPhase: "none",
                description:"Act out the interaction between people and the product/service/environment. This is a method to prototype the interaction between people and the product/service/environment.",
                steps: ["Define the scenario for key moments you want to explore",
                "Create characters for this scenario",
                "Enact the scenario",
                "Use the results to refine the design of the procuct"],
                stepsNbr:["1","2","3"],
                inPhase:[],
                participantRange: "2+",
                timeRange: "15-90m",
            ...
            },
            {
                ...
                inSprint: false,
                currentPhase: "none",
                description:"Deal with big amounts of information visually sorting them and give them prioritisation order.",
                steps: ["Each indiviual lists all their ideas on sticky notes",
                "Combine similar ideas and remove ones with low priority",
                "Sort ideas in prioritisation order by comparing them (Have the same criterias for all comparisons)",
                "When you are done comparing you will have a list sorted by importance"],
                stepsNbr:["1","2","3"],
                inPhase:[],
                participantRange: "1+",
                timeRange: "5-40m",
...

            {
                ...
                inSprint: false,
                currentPhase: "none",
                description:"Clickable wireframes are the simplest form of an interactive prototype created by linking several static wireframes together. Each wireframe contains only the key elements (content blocks and functional elements).",
                steps: ["Choose a tool such as Figma to create a clickable wireframe of the application",
                "Select the most important aspects of the application that need to be visualized",
                "Start creating the wireframe by constructing the user interface with simple shapes such as circles and rectangles",
                "Wire all of the interactible elements of the user interface, e.g. the Home button leads to the home screen, etc."],
                stepsNbr:["1","2","3","4"],
                inPhase:[],
                participantRange: "0",
                timeRange: "15-40m",
                recommendedToolsIcon: ["figma_icon.svg"],
                recommendedToolsDifficulty: ["diff2.svg"],
                recommendedToolsLink: ["http://figma.com/"],
            }
